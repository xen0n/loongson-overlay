...
LICENSE="GPL-2"
IUSE="altivec +interlaced opencl pic static-libs cpu_flags_x86_sse cpu_flags_mips_msa +threads"
...
multilib_src_configure() {
	...
	if [[ ${ABI} == x86* ]] && { use pic || use !cpu_flags_x86_sse ; } || [[ ${ABI} == "x32" ]] || [[ ${CHOST} == armv5* ]] || [[ ${ABI} == ppc* ]] && { use !altivec ; } || [[ ${CHOST} == mips* ]] && { use !cpu_flags_mips_msa ; } ; then
