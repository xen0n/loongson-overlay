...
inherit check-reqs eapi8-dosym flag-o-matic java-pkg-2 java-vm-2 multiprocessing toolchain-funcs git-r3
...
MY_PV="$(ver_rs 1 'u' 2 '-' ${PV%_p*})"
SLOT="${PV%%[.+]*}"

DESCRIPTION="Open source implementation of the Java programming language"
HOMEPAGE="https://openjdk.org"
EGIT_REPO_URI="https://github.com/loongson/jdk8u.git"
EGIT_BRANCH="master-ls"
