...
PATCHSET_LOONG="chromium-131.0.6778.85-2"
PATCHSET_LOONG_PV="131.0.6778.85"
SRC_URI="
	https://chromium-tarballs.distfiles.gentoo.org/${P}.tar.xz
...
src_unpack() {
	...
	if use loong; then
		unpack chromium-loongarch64-aosc-patches-${PATCHSET_LOONG}.tar.gz
	fi
}
